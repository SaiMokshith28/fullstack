...
class AddProject extends Component {
  ...
  componentDidUpdate(prevState) {
    ...
    if (
      this.props.projectToUpdate.projectIdentifier !==
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onUpdateProject: (project, history) =>
      dispatch(actions.updateProject(project, history)),
    getProjectUpdate: (projectId) =>
      dispatch(actions.fetchProjectToUpdate(projectId)),
  };
};
